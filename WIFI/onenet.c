...
//产品ID
#define PROID		"XPz90SBcDh"

//鉴权Token
#define TOKEN	"version=2018-10-31&res=products%2FXPz90SBcDh%2Fdevices%2Ftest&et=1872683333&method=md5&sign=jNVeaJ6scz%2FSiFiACVDDoA%3D%3D"
		...
		case MQTT_PKT_PUBLISH:														//接收的Publish消息
			...
			if(result == 0)
			{
				...
				if(Alarm_json != NULL)
				{
					...
					{
							Alarm_flag = 1;
							Usart_Printf(USART_DEBUG, "Alarm_flag = 1\r\n");									
					}
					else 
					{
							Alarm_flag = 0;
							Usart_Printf(USART_DEBUG, "Alarm_flag = 0\r\n");					
					}
				}	
				cJSON_Delete(json);
			}
